...
<head>
	...
	<!-- Daterangepicker css -->
	<link rel="stylesheet" href="{{ asset('techmin/vendor/daterangepicker/daterangepicker.css') }}">


	<!-- Vector Map css -->
	<link rel="stylesheet" href="{{ asset('techmin/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css') }}">

	<!-- Theme Config Js -->
	<script src="{{ asset('techmin/js/config.js') }}"></script>

	<!-- App css -->
	<link href="{{ asset('techmin/css/app.min.css') }}" rel="stylesheet" type="text/css" id="app-style" />
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            {{-- <div class="logo-topbar">
                ...
                <a href="index.html" class="logo-light">
                    <span class="logo-lg">
                        <img src={{ asset('techmin/images/logo.png') }} alt="logo"> 
                    </span>
                    <span class="logo-sm">
                        <img src={{ asset('techmin//images/logo-sm.png') }} alt="small logo">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo-dark">
                    <span class="logo-lg">
                        <img src="{{ asset('techmin/images/logo.png') }}" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('techmin/images/logo-sm.png') }}" alt="small logo">
                    </span>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            {{-- <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('techmin/images/flags/us.jpg') }}" alt="user-image" class="me-0 me-sm-1" height="12">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset ('techmin/images/flags/germany.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('techmin/images/flags/italy.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('techmin/images/flags/spain.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('techmin/images/flags/russia.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                    </a>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('techmin/images/users/avatar-1.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('techmin/images/users/avatar-2.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('techmin/images/users/avatar-3.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('techmin/images/users/avatar-4.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('techmin/images/users/avatar-5.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account-user-avatar">
                        {{-- <img src="{{ asset('techmin/images/users/avatar-1.jpg') }}" alt="user-image" width="32" class="rounded-circle"> --}}
                    </span>
...
<!-- ========== Topbar End ========== -->
		...
		<div class="leftside-menu">
		    ...
		    <a href="index.html" class="logo logo-dark">
		        <span class="logo-lg">
		            <img src="{{ asset('techmin/images/logo-dark.png') }}" alt="dark logo">
		        </span>
		        <span class="logo-sm">
		            <img src="{{ asset('techmin/images/logo-sm.png') }}" alt="small logo">
		        </span>
...
@endif
							...
							<div class="card overflow-hidden border-top-0">
								...
								<div class="card-body">
									...
									<div class="d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-end">
										<h3 class="mb-0 d-flex"><i class="bi bi-currency-dollar"></i>331k </h3>
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-9.jpg') }}" alt=""
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-3.jpg') }}"alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-6.jpg') }}" alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-4.jpg') }}" alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-11.jpg') }}" alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-7.jpg') }}" alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="avatar-sm">
																<img src="{{ asset('techmin/images/users/avatar-5.jpg') }}" alt=""
																	class="img-fluid rounded-circle">
															</div>
															<div class="ps-2">
				    ...
				    <div class="container-fluid">
				        <div class="row">
				            <div class="col-12 text-center">
				                <script>document.write(new Date().getFullYear())</script> © Manado -  <b>Dinas Kesehatan Manado</b>
				            </div>
				        </div>
				    </div>
				</footer>
	...
	<!-- Apex Charts js -->
	<script src="{{ asset('techmin/vendor/apexcharts/apexcharts.min.js') }}"></script>

	<!-- Vector Map js -->
	<script src="{{ asset('techmin/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
	<script src="{{ asset('techmin/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js') }}"></script>


	<!-- Dashboard App js -->
	<script src="{{ asset('techmin/js/pages/dashboard.js') }}"></script>
